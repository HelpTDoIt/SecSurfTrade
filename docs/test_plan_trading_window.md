...
```bash
# Suppose account sells filled for $12,500 (estimated was $12,000)
python -m cli.strategy --state today.json --export today_adjusted.json \
  --confirmed-proceeds '{"My Retirement Account": 12500.00}'
```

**PASS:**

- [ ] Output shows `Confirmed proceeds for My Retirement Account: $12,500.00 (est $12,000.00, ratio 1.0417)`
